 ...
 */
export type SafeIcon = ComponentType<{
    className?: string;
}>;
/**
 ...
 * ```
 */
export declare const toSafeIcon: (icon: LucideIcon) => SafeIcon;
/**
 ...
 */
export declare const toSafeIcons: (icons: LucideIcon[]) => SafeIcon[];
//# sourceMappingURL=icon-helpers.d.ts.map