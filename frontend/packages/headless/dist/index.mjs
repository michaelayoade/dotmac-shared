...
import React6__default, { createContext, useMemo, useCallback, useEffect, useContext, useState, useRef, Component } from 'react';
import { create } from 'zustand';
import { subscribeWithSelector, persist, createJSONStorage } from 'zustand/middleware';
import { z } from 'zod';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { AlertCircle, RefreshCw, WifiOff, Shield, Smartphone, Mail, Key, AlertTriangle, Clock, Wifi, CheckCircle, X, Info } from 'lucide-react';
...
var useNotificationStore = create()(
...
var ISPTenantContext = createContext(null);
...
var TerritoryValidationSchema = z.object({
  address: z.string().min(10).max(200),
...
var CustomerQueryParamsSchema = z.object({
...
function DefaultErrorFallback({ error: error2, errorInfo, resetError }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex min-h-screen flex-col justify-center bg-gray-50 py-12 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsx("div", { className: "sm:mx-auto sm:w-full sm:max-w-md", children: /* @__PURE__ */ jsx("div", { className: "bg-white px-4 py-8 shadow sm:rounded-lg sm:px-10", children: /* @__PURE__ */ jsxs("div", { className: "text-center", role: "alert", children: [
    /* @__PURE__ */ jsx("div", { className: "mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-red-100", children: /* @__PURE__ */ jsxs(
      "svg",
      {
        "aria-label": "icon",
        ...
        stroke: "currentColor",
        children: [
          /* @__PURE__ */ jsx("title", { children: "Icon" }),
          /* @__PURE__ */ jsx(
            "path",
            {
              strokeLinecap: "round",
    ...
    /* @__PURE__ */ jsx("h2", { className: "mt-4 font-medium text-gray-900 text-lg", children: "Something went wrong" }),
    /* @__PURE__ */ jsx("p", { className: "mt-2 text-gray-600 text-sm", children: "We encountered an error while loading this page. Please try again or contact support if the problem persists." }),
    isDevelopment ? /* @__PURE__ */ jsxs("details", { className: "mt-4 text-left", children: [
      /* @__PURE__ */ jsx("summary", { className: "cursor-pointer font-medium text-gray-700 text-sm hover:text-gray-900", children: "Error Details (Development)" }),
      /* @__PURE__ */ jsxs("div", { className: "mt-2 whitespace-pre-wrap rounded bg-gray-100 p-3 font-mono text-gray-800 text-xs", children: [
        ...
        errorInfo ? /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-6 flex flex-col space-y-3", children: [
      /* @__PURE__ */ jsx(
        "button",
        {
          type: "button",
...
function withErrorBoundary(Component2, errorBoundaryProps) {
  const WrappedComponent = (props) => {
    return /* @__PURE__ */ jsx(ErrorBoundary, { ...errorBoundaryProps, children: /* @__PURE__ */ jsx(Component2, { ...props }) });
  };
...
function GenericErrorFallback({ error: error2, resetError, retry, isRetrying }) {
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center p-8 text-center", children: [
    /* @__PURE__ */ jsx(AlertCircle, { className: "mb-4 h-12 w-12 text-red-500" }),
    /* @__PURE__ */ jsx("h3", { className: "mb-2 font-semibold text-gray-900 text-lg", children: "Something went wrong" }),
    /* @__PURE__ */ jsx("p", { className: "mb-4 text-gray-600", children: error2?.message || "An unexpected error occurred" }),
    /* @__PURE__ */ jsxs("div", { className: "flex space-x-3", children: [
      retry ? /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsx(RefreshCw, { className: `mr-2 h-4 w-4 ${isRetrying ? "animate-spin" : ""}` }),
            isRetrying ? "Retrying..." : "Retry"
          ]
        }
      ) : null,
      resetError ? /* @__PURE__ */ jsx(
        "button",
        {
          type: "button",
          onClick: resetError,
...
function NetworkErrorFallback({ resetError, retry, isRetrying }) {
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center p-8 text-center", children: [
    /* @__PURE__ */ jsx(WifiOff, { className: "mb-4 h-12 w-12 text-red-500" }),
    /* @__PURE__ */ jsx("h3", { className: "mb-2 font-semibold text-gray-900 text-lg", children: "Connection Problem" }),
    /* @__PURE__ */ jsx("p", { className: "mb-4 text-gray-600", children: "Unable to connect to our servers. Please check your internet connection and try again." }),
    /* @__PURE__ */ jsxs("div", { className: "flex space-x-3", children: [
      retry ? /* @__PURE__ */ jsxs(
        "button",
        {
...
function LoadingErrorFallback({ error: error2, resetError, retry, isRetrying }) {
  return /* @__PURE__ */ jsx("div", { className: "rounded-lg border border-yellow-200 bg-yellow-50 p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start", children: [
    /* @__PURE__ */ jsx(AlertCircle, { className: "mt-0.5 mr-3 h-5 w-5 text-yellow-600" }),
    /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
      /* @__PURE__ */ jsx("h4", { className: "font-medium text-sm text-yellow-800", children: "Failed to load data" }),
      /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-yellow-700", children: error2?.message || "Unable to load the requested information" }),
      /* @__PURE__ */ jsxs("div", { className: "mt-3 flex space-x-2", children: [
        retry ? /* @__PURE__ */ jsxs(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ jsx(RefreshCw, { className: `mr-1 h-3 w-3 ${isRetrying ? "animate-spin" : ""}` }),
              isRetrying ? "Retrying..." : "Retry"
            ]
          }
        ) : null,
...
function InlineErrorFallback({ error: error2, retry, isRetrying }) {
  return /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center rounded-lg border border-red-200 bg-red-50 px-3 py-4 text-center", children: /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx(AlertCircle, { className: "mr-2 inline h-4 w-4 text-red-500" }),
    /* @__PURE__ */ jsx("span", { className: "text-red-700 text-sm", children: error2?.message || "Error loading content" }),
    retry ? /* @__PURE__ */ jsx(
      "button",
      {
        type: "button",
...
function EmptyStateFallback({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "py-12 text-center", children: [
    /* @__PURE__ */ jsx("div", { className: "mx-auto mb-4 h-24 w-24 text-gray-400", children: /* @__PURE__ */ jsxs(
      "svg",
      {
        "aria-label": "icon",
        fill: "none",
    ...
    /* @__PURE__ */ jsx("h3", { className: "mb-2 font-semibold text-gray-900 text-lg", children: title }),
    /* @__PURE__ */ jsx("p", { className: "mb-4 text-gray-600", children: description }),
    action ? /* @__PURE__ */ jsx(
      "button",
      {
        type: "button",
...
function UnauthorizedFallback({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "py-12 text-center", children: [
    /* @__PURE__ */ jsx("div", { className: "mx-auto mb-4 h-12 w-12 text-yellow-500", children: /* @__PURE__ */ jsxs(
      "svg",
      {
        "aria-label": "icon",
        fill: "none",
    ...
    /* @__PURE__ */ jsx("h3", { className: "mb-2 font-semibold text-gray-900 text-lg", children: "Access Required" }),
    /* @__PURE__ */ jsx("p", { className: "mb-4 text-gray-600", children: message }),
...
function MaintenanceFallback({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "py-12 text-center", children: [
    /* @__PURE__ */ jsx("div", { className: "mx-auto mb-4 h-12 w-12 text-orange-500", children: /* @__PURE__ */ jsxs(
      "svg",
      {
        "aria-label": "icon",
        fill: "none",
    ...
    /* @__PURE__ */ jsx("h3", { className: "mb-2 font-semibold text-gray-900 text-lg", children: "Under Maintenance" }),
    /* @__PURE__ */ jsx("p", { className: "mb-4 text-gray-600", children: "We're performing some maintenance to improve your experience. Please check back soon." }),
    estimatedTime ? /* @__PURE__ */ jsxs("p", { className: "mb-4 text-gray-500 text-sm", children: [
      "Estimated completion: ",
      estimatedTime
    ] }) : null,
    contactSupport ? /* @__PURE__ */ jsx(
      "button",
      {
        type: "button",
...
function MFASetup({ onComplete, onCancel }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsx(Shield, { className: "mx-auto mb-4 h-12 w-12 text-blue-600" }),
      /* @__PURE__ */ jsx("h3", { className: "mb-2 font-semibold text-gray-900 text-lg", children: "Multi-Factor Authentication" }),
      /* @__PURE__ */ jsx("p", { className: "text-gray-600", children: "Select the MFA method you want to use and complete the enrollment flow." })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "space-y-3", children: AVAILABLE_METHODS.map((method) => /* @__PURE__ */ jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          /* @__PURE__ */ jsx("span", { className: "capitalize", children: method.replace("_", " ") }),
          selectedMethod === method && /* @__PURE__ */ jsx(CheckIcon, {})
        ]
      },
      method
    )) }),
    /* @__PURE__ */ jsx("div", { className: "rounded-lg border border-gray-200 bg-gray-50 p-4 text-sm text-gray-600", children: "Complete the enrollment process with your selected method. When the enrollment succeeds, confirm below." }),
    /* @__PURE__ */ jsxs("label", { className: "flex items-center space-x-2 text-sm text-gray-700", children: [
      /* @__PURE__ */ jsx(
        "input",
        {
          type: "checkbox",
      ...
      /* @__PURE__ */ jsx("span", { children: "I have finished configuring MFA for this user." })
    ] }),
...
function MFAVerification({ method = "totp", onSuccess, onCancel }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsx(Icon, { className: "mx-auto mb-4 h-12 w-12 text-blue-600" }),
      /* @__PURE__ */ jsx("h3", { className: "mb-2 font-semibold text-gray-900 text-lg", children: "Verify your identity" }),
      /* @__PURE__ */ jsx("p", { className: "text-gray-600", children: label })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
      ...
      error2 && /* @__PURE__ */ jsx("p", { className: "text-sm text-red-600", children: error2 })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex gap-3", children: [
      /* @__PURE__ */ jsx(
        "button",
...
function CheckIcon() {
  return /* @__PURE__ */ jsx("span", { className: "flex h-5 w-5 items-center justify-center rounded-full bg-blue-600 text-white text-xs", children: "\u2713" });
}
var notificationIcons = {
  success: /* @__PURE__ */ jsx(CheckCircle, { className: "h-5 w-5 text-green-600" }),
  error: /* @__PURE__ */ jsx(AlertCircle, { className: "h-5 w-5 text-red-600" }),
  warning: /* @__PURE__ */ jsx(AlertTriangle, { className: "h-5 w-5 text-yellow-600" }),
  info: /* @__PURE__ */ jsx(Info, { className: "h-5 w-5 text-blue-600" }),
  system: /* @__PURE__ */ jsx(Info, { className: "h-5 w-5 text-slate-600" })
};
...
var NotificationRenderers = {
  ...
  title: ({ title }) => /* @__PURE__ */ jsx("p", { className: "font-medium text-sm", children: title }),
  message: ({ message }) => message ? /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm opacity-90", children: message }) : null,
  closeButton: ({
    onDismiss,
    id,
    persistent
  }) => persistent ? null : /* @__PURE__ */ jsx(
    "button",
    {
      type: "button",
  ...
  actions: ({
    actions,
    onDismiss
  }) => actions && actions.length > 0 ? /* @__PURE__ */ jsx("div", { className: "mt-3 flex space-x-2", children: actions.map((action, index) => {
  ...
  persistentDismiss: ({
    onDismiss,
    persistent
  }) => persistent ? /* @__PURE__ */ jsx("div", { className: "mt-3 flex justify-end", children: /* @__PURE__ */ jsx(
    "button",
    {
      type: "button",
      onClick: onDismiss,
  ...
  progressBar: ({ duration, persistent }) => duration && duration > 0 && !persistent ? /* @__PURE__ */ jsx("div", { className: "h-1 bg-gray-200", children: /* @__PURE__ */ jsx(
    "div",
    {
...
function NotificationComponent({ notification, onDismiss }) {
  ...
  const renderHeader = () => /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { className: "flex-shrink-0", children: NotificationRenderers.icon({ type: notification.type }) }),
    /* @__PURE__ */ jsx("div", { className: "ml-3 w-0 flex-1", children: /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
  ...
  const renderBody = () => /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "p-4", children: [
          /* @__PURE__ */ jsx("div", { className: "flex items-start", children: renderHeader() }),
          renderBody(),
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "flex w-full flex-col items-center space-y-4 sm:items-end", children: [
          notifications.slice(0, 5).map((notification) => /* @__PURE__ */ jsx(
          ...
          notifications.length > 5 && /* @__PURE__ */ jsx("div", { className: "w-full max-w-sm rounded-lg bg-gray-800 px-4 py-2 text-center text-white shadow-lg", children: /* @__PURE__ */ jsxs("p", { className: "text-xs", children: [
            "+",
...
var AuthContext = React6.createContext(defaultAuthState);
function useAuth() {
  return React6.useContext(AuthContext);
}
...
function usePortalIdAuth() {
  const portalAuthFetch2 = useMemo(() => createPortalAuthFetch(DEFAULT_PORTAL_TOKEN_KEY), []);
  ...
  const validatePortalId = useCallback((portalId) => {
    const errors = [];
  ...
  const setupMfa = useCallback(async (secret, code) => {
    const accessToken = localStorage.getItem("access_token");
    if (!accessToken) return false;
    try {
...
function useCustomRouteProtection(config) {
  ...
  const validateCustomRoute = useCallback(() => {
...
function RouteGuard({
  ...
  if (protection.isLoading) {
    return loadingComponent || /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center p-8", children: [
      /* @__PURE__ */ jsx("div", { className: "h-6 w-6 animate-spin rounded-full border-blue-600 border-b-2" }),
      /* @__PURE__ */ jsx("span", { className: "ml-2 text-gray-600 text-sm", children: "Checking permissions..." })
    ] });
  }
  if (!protection.isAllowed) {
    if (unauthorizedComponent) {
      return /* @__PURE__ */ jsx(Fragment, { children: unauthorizedComponent });
    }
    if (fallback) {
      return /* @__PURE__ */ jsx(Fragment, { children: fallback });
    }
    return /* @__PURE__ */ jsxs("div", { className: "p-8 text-center", children: [
      /* @__PURE__ */ jsx("div", { className: "mb-4 inline-flex h-12 w-12 items-center justify-center rounded-full bg-red-100", children: /* @__PURE__ */ jsxs(
        "svg",
        {
          "aria-label": "icon",
          className: "h-6 w-6 text-red-600",
      ...
      /* @__PURE__ */ jsx("h3", { className: "mb-2 font-medium text-gray-900 text-lg", children: "Access Restricted" }),
      /* @__PURE__ */ jsx("p", { className: "text-gray-600 text-sm", children: getAccessDeniedMessage(protection.reason) })
    ] });
  }
...
function CustomerOnlyGuard({
  ...
  return /* @__PURE__ */ jsx(RouteGuard, { allowedPortals: ["customer"], requiredRoles: ["customer"], fallback, children });
}
...
function PermissionGuard({
  ...
  return /* @__PURE__ */ jsx(RouteGuard, { requiredPermissions: permissions, fallback, children });
}
function FeatureGuard({
  ...
  return /* @__PURE__ */ jsx(RouteGuard, { requiredFeatures: features2, fallback, children });
}
...
function ISPTenantProvider({
  ...
  return /* @__PURE__ */ jsx(ISPTenantContext.Provider, { value: tenantHook, children });
}
...
function useFieldOperations() {
  const webSocket = useWebSocket();
  const [workOrderUpdates, setWorkOrderUpdates] = useState([]);
  const [technicianLocations, setTechnicianLocations] = useState(/* @__PURE__ */ new Map());
  useEffect(() => {
...
function RealTimeProvider({ children, enabled = true }) {
  ...
  if (!enabled) {
    ...
    return /* @__PURE__ */ jsx(RealTimeContext.Provider, { value: mockContext, children });
  }
  const contextValue = {
  ...
  return /* @__PURE__ */ jsx(RealTimeContext.Provider, { value: contextValue, children });
}
  ...
  if (!showDetails) {
    return /* @__PURE__ */ jsxs("div", { className: `flex items-center space-x-2 ${className}`, children: [
      /* @__PURE__ */ jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsx(Icon, { className: `w-4 h-4 ${statusInfo.color}` }),
      ...
      showDetails && /* @__PURE__ */ jsx("span", { className: `text-sm font-medium ${statusInfo.color}`, children: statusInfo.status })
    ] });
  }
  return /* @__PURE__ */ jsx("div", { className: `${statusInfo.bg} ${statusInfo.border} border rounded-lg p-3 ${className}`, children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-2", children: [
      /* @__PURE__ */ jsx(Icon, { className: `w-5 h-5 ${statusInfo.color}` }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsxs("p", { className: `text-sm font-medium ${statusInfo.color}`, children: [
          "Real-Time: ",
          statusInfo.status
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-600", children: statusInfo.description })
      ] })
    ] }),
    error2 && /* @__PURE__ */ jsx(
      "button",
...
function useAuditLogger(config) {
  ...
  const createContext9 = useCallback(
    (additionalContext) => {
      return {
        source: serviceName,
...
function AuditProvider({
  ...
  return /* @__PURE__ */ jsx(AuditContext.Provider, { value: contextValue, children });
}
function useAudit() {
...
function withAudit(Component2, serviceName, auditConfig) {
  return function AuditWrappedComponent(props) {
    return /* @__PURE__ */ jsx(AuditProvider, { serviceName, ...auditConfig, children: /* @__PURE__ */ jsx(Component2, { ...props }) });
  };
}
...
function AuditIntegrationWrapper({
  ...
  return /* @__PURE__ */ jsx(
    AuditProvider,
    {
      ...
      enableLocalStorage,
      enableConsoleLogging,
      children: /* @__PURE__ */ jsx(AuditWrapperContent, { interceptorConfig, children })
    }
  );
}
var AuditPresets = {
...
var CustomerPortalAudit = ({ children }) => /* @__PURE__ */ jsx(AuditIntegrationWrapper, { ...AuditPresets.customerPortal, children });
var AdminPortalAudit = ({ children }) => /* @__PURE__ */ jsx(AuditIntegrationWrapper, { ...AuditPresets.adminPortal, children });
var TechnicianAppAudit = ({ children }) => /* @__PURE__ */ jsx(AuditIntegrationWrapper, { ...AuditPresets.technicianApp, children });
var ResellerPortalAudit = ({ children }) => /* @__PURE__ */ jsx(AuditIntegrationWrapper, { ...AuditPresets.resellerPortal, children });
var ManagementPortalAudit = ({ children }) => /* @__PURE__ */ jsx(AuditIntegrationWrapper, { ...AuditPresets.managementPortal, children });
...
function useBilling(options = {}) {
  ...
  return {
    ...
    selectAccount: useCallback((account) => {
...
function useSecureForm({
  ...
  const [csrfToken] = useState(() => enableCSRFProtection ? generateCSRFToken() : "");
  ...
  const sanitizeInput3 = useCallback(
    (value) => {
      if (shouldPreventXSS) {
...
function usePerformanceReporting(metrics, config) {
  const reportingTimerRef = useRef();
  useEffect(() => {
...
function useProvisioning(options = {}) {
  ...
  return {
    ...
    selectRequest: useCallback((request) => {
...
function useFormatting() {
  ...
  const formatDataSize = useCallback((bytes, precision = 2) => {
...
function useFormValidation(initialValues, options) {
  ...
  const setError = useCallback((field, error2) => {
...
var CommissionCalculationInputSchema = z.object({
  customerId: z.string().min(1),
  partnerId: z.string().min(1),
  ...
  contractLength: z.number().min(1).max(36),
  // 1-36 months
  promotionalRate: z.number().min(0).max(1).optional(),
  territoryBonus: z.number().min(0).max(0.05).optional()
...
var ValidationResultSchema = z.object({
  ...
  conflictingTerritories: z.array(
    z.object({
...
function useBusinessValidation(partnerId) {
  ...
  const cacheValidation = useCallback((key, result) => {
...
function NonceScript({
  ...
  if (props.src) {
    return /* @__PURE__ */ jsx(Script, { nonce: currentNonce, ...props });
  }
  return /* @__PURE__ */ jsx(
    "script",
    {
...
function NonceProvider({ children, nonce }) {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    nonce && /* @__PURE__ */ jsx("meta", { name: "csp-nonce", content: nonce }),
    children
  ] });
}
var StandardErrorBoundary = class extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    if (hasError && error2 && errorId) {
      ...
      if (CustomFallback) {
        return /* @__PURE__ */ jsx(CustomFallback, { ...fallbackProps });
      }
      switch (level) {
        case "application":
          return /* @__PURE__ */ jsx(ApplicationErrorFallback, { ...fallbackProps });
        case "widget":
          return /* @__PURE__ */ jsx(WidgetErrorFallback, { ...fallbackProps });
        default:
          return /* @__PURE__ */ jsx(ComponentErrorFallback, { ...fallbackProps });
      }
    }
    return children;
  }
...
var ApplicationErrorFallback = ({
  ...
  onRetry,
  hasReachedMaxRetries
}) => /* @__PURE__ */ jsx("div", { className: "min-h-screen flex items-center justify-center bg-gray-50 p-4", children: /* @__PURE__ */ jsx("div", { className: "max-w-md w-full bg-white rounded-lg shadow-lg p-6", children: /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
  /* @__PURE__ */ jsx("div", { className: "mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-red-100 mb-4", children: /* @__PURE__ */ jsx(
    "svg",
    {
      className: "h-6 w-6 text-red-600",
      fill: "none",
  ...
  /* @__PURE__ */ jsx("h1", { className: "text-xl font-semibold text-gray-900 mb-2", children: "Application Error" }),
  /* @__PURE__ */ jsx("p", { className: "text-gray-600 mb-4", children: error2.userMessage }),
  /* @__PURE__ */ jsxs("div", { className: "text-sm text-gray-500 mb-6", children: [
    "Error ID: ",
    errorId
  ] }),
  /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row gap-3 justify-center", children: [
    !hasReachedMaxRetries && /* @__PURE__ */ jsx(
      "button",
      {
        onClick: onRetry,
...
var ComponentErrorFallback = ({
  ...
  onClearError,
  hasReachedMaxRetries
}) => /* @__PURE__ */ jsx("div", { className: "border border-red-200 rounded-md bg-red-50 p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex", children: [
  /* @__PURE__ */ jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsx("svg", { className: "h-5 w-5 text-red-400", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: /* @__PURE__ */ jsx(
    "path",
    {
      strokeLinecap: "round",
      strokeLinejoin: "round",
  ...
  /* @__PURE__ */ jsxs("div", { className: "ml-3", children: [
    /* @__PURE__ */ jsx("h3", { className: "text-sm font-medium text-red-800", children: "Component Error" }),
    /* @__PURE__ */ jsx("p", { className: "text-sm text-red-700 mt-1", children: error2.userMessage }),
    /* @__PURE__ */ jsxs("div", { className: "text-xs text-red-600 mt-1", children: [
      "ID: ",
      errorId
    ] }),
...
var WidgetErrorFallback = ({
  ...
  onRetry,
  hasReachedMaxRetries
}) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center p-2 text-sm text-gray-500 bg-gray-50 border rounded", children: [
  /* @__PURE__ */ jsx(
    "svg",
    {
  ...
  /* @__PURE__ */ jsx("span", { className: "flex-1", children: "Unable to load" }),
  !hasReachedMaxRetries && /* @__PURE__ */ jsx(
    "button",
    {
      onClick: onRetry,
...
function withErrorBoundary2(Component2, errorBoundaryProps) {
  const WrappedComponent = (props) => /* @__PURE__ */ jsx(StandardErrorBoundary, { ...errorBoundaryProps, children: /* @__PURE__ */ jsx(Component2, { ...props }) });
  WrappedComponent.displayName = `withErrorBoundary(${Component2.displayName || Component2.name})`;
  return WrappedComponent;
}
function useErrorBoundary2() {
  const [error2, setError] = React6__default.useState(null);
  const captureError = React6__default.useCallback((error3) => {
    setError(error3);
  }, []);
  const clearError = React6__default.useCallback(() => {
    setError(null);
  }, []);
  if (error2) {
    throw error2;
...
var ErrorHandlingContext = createContext(null);
function ErrorHandlingProvider({
  ...
  const errorStats = React6__default.useMemo(() => {
    const stats = {
  ...
  return /* @__PURE__ */ jsx(ErrorHandlingContext.Provider, { value: contextValue, children });
}
...
function ErrorDevOverlay() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "fixed bottom-4 right-4 z-50", children: [
    !isVisible && globalErrors.length > 0 && /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          ...
          errorStats.criticalErrors > 0 && /* @__PURE__ */ jsxs("span", { className: "ml-1 bg-red-800 px-1 rounded text-xs", children: [
    ...
    isVisible && /* @__PURE__ */ jsxs("div", { className: "bg-white border border-red-200 rounded-lg shadow-xl max-w-md w-96 max-h-96 overflow-hidden", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-3 bg-red-50 border-b", children: [
        /* @__PURE__ */ jsx("h3", { className: "font-semibold text-red-800", children: "Recent Errors" }),
      ...
      /* @__PURE__ */ jsx("div", { className: "overflow-y-auto max-h-80 p-2", children: globalErrors.map((error2, index) => /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-1", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-gray-500", children: new Date(error2.timestamp).toLocaleTimeString() })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "font-medium text-gray-900 mb-1", children: error2.message }),
            /* @__PURE__ */ jsx("div", { className: "text-gray-600", children: error2.context }),
            error2.userMessage && /* @__PURE__ */ jsxs("div", { className: "text-blue-600 mt-1", children: [
              "User: ",
              error2.userMessage
            ] })
          ]
...
function useManagementOperations(config) {
  ...
  const retryFailedOperation = useCallback(async (operationId) => {
  ...
  const subscribeToEntity = useCallback((entityType, entityId) => {
...
var ManagementContext = createContext(null);
var ManagementErrorBoundary = class extends React6__default.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    if (this.state.hasError) {
      return /* @__PURE__ */ jsx("div", { className: "management-error-boundary p-6 bg-red-50 border border-red-200 rounded-lg", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "ml-3", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-sm font-medium text-red-800", children: "Management System Error" }),
          /* @__PURE__ */ jsx("div", { className: "mt-2 text-sm text-red-700", children: /* @__PURE__ */ jsx("p", { children: "An error occurred in the management system. Please refresh the page or contact support if the problem persists." }) }),
          ...
          process.env["NODE_ENV"] === "development" && /* @__PURE__ */ jsxs("details", { className: "mt-4", children: [
            /* @__PURE__ */ jsx("summary", { className: "cursor-pointer text-sm font-medium text-red-800", children: "Error Details (Development)" }),
            /* @__PURE__ */ jsx("pre", { className: "mt-2 text-xs text-red-700 bg-red-100 p-2 rounded overflow-auto", children: this.state.error?.stack })
          ] })
        ] })
      ] }) });
    }
...
function ManagementProvider({
  ...
  const [performance3, setPerformance] = useState({
    apiResponseTimes: {},
    cacheHitRatio: 0,
    errorRate: 0
  });
  ...
  const content = /* @__PURE__ */ jsx(ManagementContext.Provider, { value: contextValue, children });
  if (enableErrorBoundary) {
    return /* @__PURE__ */ jsx(ManagementErrorBoundary, { onError: handleError, children: content });
  }
  return content;
}
...
function UnifiedBillingExample({
  ...
  if (!isInitialized2) {
    return /* @__PURE__ */ jsx("div", { className: "p-4", children: "Initializing management system..." });
  }
  return /* @__PURE__ */ jsxs("div", { className: "p-6 max-w-4xl mx-auto", children: [
    /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsx("h1", { className: "text-2xl font-bold text-gray-900", children: "Unified Billing Operations" }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-6 p-4 bg-gray-50 rounded-lg", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-lg font-semibold mb-3", children: "Customer Selection" }),
      customerEntity.isLoading() ? /* @__PURE__ */ jsx("div", { className: "text-gray-500", children: "Loading customers..." }) : customerEntity.hasError() ? /* @__PURE__ */ jsxs("div", { className: "text-red-500", children: [
        "Error: ",
        ...
        "select",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("option", { value: "", children: "Select a customer..." }),
            /* @__PURE__ */ jsx("option", { value: "cust_001", children: "Customer 001 - John Doe" }),
            /* @__PURE__ */ jsx("option", { value: "cust_002", children: "Customer 002 - Jane Smith" }),
            /* @__PURE__ */ jsx("option", { value: "cust_003", children: "Customer 003 - Acme Corp" })
          ]
        }
      )
    ] }),
    selectedCustomerId && /* @__PURE__ */ jsxs("div", { className: "mb-6 p-4 bg-blue-50 rounded-lg", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-lg font-semibold mb-3", children: "Billing Operations" }),
      billingOps.isLoading("billingData") ? /* @__PURE__ */ jsx("div", { className: "text-gray-500", children: "Loading billing data..." }) : billingOps.hasError("billingData") ? /* @__PURE__ */ jsxs("div", { className: "text-red-500", children: [
        "Error: ",
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "p-3 bg-white rounded border", children: [
            /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-600", children: "Outstanding Balance" }),
            /* @__PURE__ */ jsx("div", { className: "text-xl font-bold text-red-600", children: "$1,234.56" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "p-3 bg-white rounded border", children: [
            /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-600", children: "This Month" }),
            /* @__PURE__ */ jsx("div", { className: "text-xl font-bold text-green-600", children: "$567.89" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "p-3 bg-white rounded border", children: [
            /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-600", children: "Total Paid" }),
            /* @__PURE__ */ jsx("div", { className: "text-xl font-bold text-blue-600", children: "$12,345.67" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
          /* @__PURE__ */ jsx(
    ...
    showAnalytics && features2.enableAdvancedAnalytics && /* @__PURE__ */ jsxs("div", { className: "mb-6 p-4 bg-green-50 rounded-lg", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-lg font-semibold mb-3", children: "Analytics Dashboard" }),
      analytics.isLoading("dashboardStats") ? /* @__PURE__ */ jsx("div", { className: "text-gray-500", children: "Loading analytics..." }) : analytics.hasError("dashboardStats") ? /* @__PURE__ */ jsxs("div", { className: "text-red-500", children: [
        "Error: ",
        analytics.getError("dashboardStats")?.message
      ] }) : /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "p-3 bg-white rounded border", children: [
          /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-600", children: "Total Revenue" }),
          /* @__PURE__ */ jsx("div", { className: "text-xl font-bold text-green-600", children: "$45,678.90" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "p-3 bg-white rounded border", children: [
          /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-600", children: "Active Customers" }),
          /* @__PURE__ */ jsx("div", { className: "text-xl font-bold text-blue-600", children: "1,234" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "p-3 bg-white rounded border", children: [
          /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-600", children: "Conversion Rate" }),
          /* @__PURE__ */ jsx("div", { className: "text-xl font-bold text-purple-600", children: "12.3%" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "p-3 bg-white rounded border", children: [
          /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-600", children: "Churn Rate" }),
          /* @__PURE__ */ jsx("div", { className: "text-xl font-bold text-red-600", children: "2.1%" })
        ] })
      ] }),
    ...
    showBulkOperations && features2.enableBatchOperations && /* @__PURE__ */ jsxs("div", { className: "p-4 bg-orange-50 rounded-lg", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-lg font-semibold mb-3", children: "Bulk Operations" }),
      /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600 mb-3", children: "Available for Management Admin portal with batch operations enabled" }),
      /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
        /* @__PURE__ */ jsx("button", { className: "px-4 py-2 bg-orange-600 text-white rounded hover:bg-orange-700", children: "Bulk Invoice Generation" }),
        /* @__PURE__ */ jsx("button", { className: "px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700", children: "Bulk Payment Processing" }),
        /* @__PURE__ */ jsx("button", { className: "px-4 py-2 bg-yellow-600 text-white rounded hover:bg-yellow-700", children: "Bulk Customer Import" })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "mt-6 p-4 bg-gray-100 rounded-lg", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-lg font-semibold mb-3", children: "Portal Configuration" }),
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4 text-sm", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("strong", { children: "Portal Type:" }),
          " ",
          portalType
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("strong", { children: "Real-time Sync:" }),
          " ",
          features2.enableRealTimeSync ? "Enabled" : "Disabled"
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("strong", { children: "Advanced Analytics:" }),
          " ",
          features2.enableAdvancedAnalytics ? "Enabled" : "Disabled"
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("strong", { children: "Batch Operations:" }),
          " ",
          features2.enableBatchOperations ? "Enabled" : "Disabled"
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("strong", { children: "Audit Logging:" }),
          " ",
...
export { AdminOnlyGuard, AdminPortalAudit, ApiClient, AuditIntegrationWrapper, AuditPresets, AuditProvider, BillingCycle, BillingManagerGuard, COMMON_SCHEMAS, CUSTOMER_PORTAL_TOKEN_KEY, ConfigProvider, CustomerOnlyGuard, CustomerPortalAudit, DEFAULT_COMMISSION_TIERS, DEFAULT_ERROR_CONFIG, DEFAULT_PORTAL_TOKEN_KEY, EmptyStateFallback, EntityStatus, EntityType, ErrorBoundary, ErrorDevOverlay, ErrorHandlingProvider, FeatureGuard, GenericErrorFallback, ISPApiClient, ISPBusinessService, ISPError, ISPTenantProvider, InlineErrorFallback, InvoiceStatus, LoadingErrorFallback, MFASetup, MFAVerification, MaintenanceFallback, ManagementApiClient, ManagementPortalAudit, ManagementProvider, NetworkEngineerGuard, NetworkErrorFallback, NonceProvider, NonceScript, NotificationContainer, NotificationProvider, PLUGIN_PATTERNS, PaymentMethod, PaymentStatus, PermissionGuard, PortalAuthError, PricingModel, RateLimiter, RealTimeProvider, RealTimeStatus, ReportFormat, ReportStatus, ReportType, ResellerOnlyGuard, ResellerPortalAudit, RouteGuard, ServiceType, StandardErrorBoundary, SupportAgentGuard, TechnicianAppAudit, ThemeProvider, UnauthorizedFallback, UnifiedBillingExample, VALIDATION_PATTERNS, adminTheme, buildPortalAuthHeaders, calculateRetryAfter, calculateRetryDelay, checkApiHealth, classifyError, clearOperatorAuthTokens, commissionEngine, configureGlobalErrorHandling as configureISPErrorHandling, configureGlobalErrorHandling2 as configureStandardErrorHandling, createApiClient, createISPApiClient, createISPBusinessService, createMockDataGuard, createMockGenerator, createPortalAuthFetch, createRateLimit, createRateLimitMiddleware, createSpan, csrfProtection, customerTheme, deduplicateError, defaultConfigs, defaultFrameworkConfig, defaultMockGuard, defaultTheme, devOnly, escapeHTML, extractNonce, generateCSP, generateCSPMeta, generateNonce, getApiClient, getApiConfig, getClientIdentifier, getGlobalErrorConfig, getISPApiClient, getOperatorAccessToken, getPartnerApiClient, getPortalAuthToken, initializeApi, initializeOTEL, inputSanitizer, isApiInitialized, isValidNonce, ispApiClient, logError, mockApiWrapper, mockData, getPartnerApiClient as partnerApiClient, partnerQueryKeys, performance2 as performance, portalAuthFetch, rateLimiter, rateLimiters, recordMetric, requireApiClient, resellerTheme, safeConsole, sanitizeEmail, sanitizeHTML, sanitizeInput2 as sanitizeInput, sanitizeText, sanitizeURL, secureStorage, setGlobalErrorHandler, setGlobalISPApiClient, setOperatorAccessToken, shouldRetry, territoryValidator, testOnly, themes, tokenManager, useAdminBusiness, useApiClient, useApiData, useApiErrorNotifications, useAppNotifications, useAppState, useAppStore, useAsyncValidation, useAudit, useBilling, useBorderRadius, useBrandingConfig, useBreakpoints, useBusinessConfig, useBusinessValidation, useCSRFProtection, useApiData as useCachedData, useColors, useCommunication, useConfig, useCreateCustomer, useCurrencyConfig, useCustomRouteProtection, useCustomerActivity, useCustomerBilling, useCustomerBusiness, useCustomerDashboard, useCustomerDocuments, useCustomerServices, useCustomerSupportTickets, useCustomerUsage, useDataLoadingErrorHandler, useDataTable, useErrorBoundary2 as useErrorBoundary, useErrorBoundaryHook, useErrorHandling, useErrorNotifications, useErrorReporting, useFeatureFlags, useFieldOperations, useFilters, useFormErrorHandler, useFormState, useFormSubmission, useFormValidation, useFormatting, useGlobalErrorListener, useISPBusiness, useISPModules, useISPTenant, useISPTenantProvider, useErrorBoundary as useLegacyErrorBoundary, useStandardErrorHandler as useLegacyErrorHandler, useLoading, useLocaleConfig, useManagement, useManagementAnalytics, useManagementBilling, useManagementBusiness, useManagementConfig, useManagementEntity, useManagementOperations, useManagementPerformance, useMockData, useNetworkMonitoring, useNonce, useNotificationStore, useNotifications, usePagination, usePartnerAnalytics, usePartnerCommissions, usePartnerCustomer, usePartnerCustomers, usePartnerDashboard, usePartnerDataWithErrorBoundary, usePerformanceMonitoring, usePortalIdAuth, usePreferences, useProvisioning, useRealTime, useRealtimeErrorHandler, useResellerBusiness, useRouteProtection, useSecureForm, useSelection, useShadows, useSpacing, useApiErrorHandler as useStandardApiErrorHandler, useStandardErrorHandler, useTechnicianBusiness, useTenantStore, useTheme, useToast, useTypography, useUI, useUpdateCustomer, useUploadErrorHandler, useValidateTerritory, useWebSocket, validateFormData, validateInput, withAudit, withErrorBoundary, withErrorFallback, withErrorBoundary2 as withStandardErrorBoundary };
