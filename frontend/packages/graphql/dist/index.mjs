...
function DefaultLoadingSkeleton() {
  return /* @__PURE__ */ jsxs("div", { className: "space-y-4 animate-pulse", children: [
    /* @__PURE__ */ jsx("div", { className: "h-8 bg-gray-200 rounded w-1/4" }),
...
function DefaultErrorDisplay({ error }) {
  return /* @__PURE__ */ jsx("div", { className: "rounded-md bg-red-50 p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex", children: [
    /* @__PURE__ */ jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsx("svg", { className: "h-5 w-5 text-red-400", viewBox: "0 0 20 20", fill: "currentColor", children: /* @__PURE__ */ jsx(
      "path",
      {
        fillRule: "evenodd",
...
function DefaultEmptyState() {
  return /* @__PURE__ */ jsxs("div", { className: "text-center py-12", children: [
    ...
    /* @__PURE__ */ jsx("h3", { className: "mt-2 text-sm font-medium text-gray-900", children: "No data" }),
    /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-gray-500", children: "No results found for this query" })
  ] });
}
function QueryBoundary({
  ...
  if (result.loading) {
    return /* @__PURE__ */ jsx(Fragment, { children: loadingComponent ?? /* @__PURE__ */ jsx(DefaultLoadingSkeleton, {}) });
  }
  if (result.error) {
    return /* @__PURE__ */ jsx(Fragment, { children: errorComponent ? errorComponent(result.error) : /* @__PURE__ */ jsx(DefaultErrorDisplay, { error: result.error }) });
  }
  if (result.data === void 0 || result.data === null) {
    return /* @__PURE__ */ jsx(Fragment, { children: emptyComponent ?? /* @__PURE__ */ jsx(DefaultEmptyState, {}) });
  }
  if (!skipEmptyCheck && isEmpty && isEmpty(result.data)) {
    return /* @__PURE__ */ jsx(Fragment, { children: emptyComponent ?? /* @__PURE__ */ jsx(DefaultEmptyState, {}) });
  }
  return /* @__PURE__ */ jsx(Fragment, { children: children(result.data) });
}
...
export {
  ...
  ProductTypeEnum,
  QueryBoundary,
  react_query_exports as ReactQueryHooks,
  RfAnalyticsDocument,
  RoleListDocument,
