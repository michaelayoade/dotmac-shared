...
var AuthInterceptor = class {
  ...
  getToken() {
    switch (this.config.tokenSource) {
      case "cookie":
        return Cookies2.get(this.config.tokenKey) || null;
      case "localStorage":
  ...
  getRefreshToken() {
    ...
    switch (this.config.tokenSource) {
      case "cookie":
        return Cookies2.get(this.config.refreshTokenKey) || null;
      case "localStorage":
        if (typeof window !== "undefined") {
  ...
  setToken(token) {
    switch (this.config.tokenSource) {
      case "cookie":
        Cookies2.set(this.config.tokenKey, token, {
          secure: true,
          sameSite: "strict",
          expires: 7
          // 7 days
  ...
  setRefreshToken(token) {
    ...
    switch (this.config.tokenSource) {
      case "cookie":
        Cookies2.set(this.config.refreshTokenKey, token, {
          secure: true,
          sameSite: "strict",
          expires: 30
          // 30 days
  ...
  clearTokens() {
    switch (this.config.tokenSource) {
      case "cookie":
        Cookies2.remove(this.config.tokenKey);
        if (this.config.refreshTokenKey) {
          Cookies2.remove(this.config.refreshTokenKey);
        }
        break;
      case "localStorage":
        if (typeof window !== "undefined") {
